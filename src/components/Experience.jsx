...
const Experience = () => {
  ...
  return (
    <div name="experience"
    className="bg-gradient-to-b from-white to-blue-50 w-full pt-6 h-screen">
        <div className='max-w-screen-lg mx-auto p-4 flex flex-col justify-center w-full h-full'>
            ...
            <div className='w-full grid grid-cols-2 sm:grid-cols-3 gap-8 text-center py-8 px-12 sm:px-0 sm:mb-2 sm:mt-2 md:mt-2'>
