    ...
    >
      <div className="max-w-screen-lg mx-auto flex flex-col items-center justify-center h-full px-4 md:flex-row">
        <div className="flex flex-col justify-center h-full">
          ...
          <p className="text-white py-4 max-w-full">
          A very detail oriented Software Developer currently working @Capgemini as a Software Engineer from 
          Sept '21. 
          <br />
          <h3 className="text-xl font-bold my-3  text-white"><mark class="px-2 text-white bg-blue-600 rounded dark:bg-blue-500">Projects i have worked on </mark></h3>
          <ul>
            <h4 className="text-yellow-100">C++  Developer (March' 22 - Current)</h4>
            <p className="font-bold underline">Key responsibilities - </p>
            <li>- Working closely on designing and implementing new features on the product.</li>
            ...
            <ul>
            <h4 className="text-yellow-100">Python Automation using ROBOT framework (Sept' 21 - Feb' 22)</h4>
            <p className="font-bold underline">Key responsibilities - </p>
