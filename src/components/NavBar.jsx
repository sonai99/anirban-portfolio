...
const NavBar = () => {
  ...
  return (
    <div className="flex justify-between items-center w-full h-20 bg-black text-white px-4 overflow-hidden">
        <div>
            <h1 className="text-3xl ml-2 text-green-300 font-medium hover:scale-105 duration-200">
            <NavLink to="/" className='text-white text-5xl font-bold underline'>ad.</NavLink>
            </h1>
        </div>
