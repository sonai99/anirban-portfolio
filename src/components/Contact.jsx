      ...
      <div className='flex flex-col justify-center max-w-screen-lg mx-auto h-full'>
        ...
        <div className='flex justify-center items-center'>
          <form action="https://getform.io/f/a1bf410e-08d2-4ca2-94d7-d3d50fffa1e7" method="POST" className='flex flex-col w-full md:w-1/2 '>
            ...
            <textarea name="message" id="" rows="10" placeholder="Enter your message" className='p-2 bg-transparent border-2 rounded-md text-white focus:outlie-none'></textarea>
